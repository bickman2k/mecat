 ...
 * @author Stephan Richard Palm
 *
 * Regioncode is declared final because it extends ChoiceFeature and sets the attributeName.
 * All classes extending Format would save there information on the same spot.
 */
public class Regioncode extends ChoiceFeature {

	public Regioncode(Medium medium) {
        super(medium, getEasyClassName(Regioncode.class.getName()));
	}

	static public ConfigurableComparator getComparator(){
		return new ByChoiceFromChoiceFeature(Regioncode.class);
	}
}
