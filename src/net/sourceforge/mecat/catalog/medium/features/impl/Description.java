...
public class Description extends TextFeature {

	public Description(Medium medium) {
		super(medium, "Description", false, true);
	}

	public String getText() {
		if (get() == null)
            return Options.getI18N(Description.class).getString("The Desciption is not set.");
		return get();
	}
	...
	static public ConfigurableComparator getComparator(){
		return new ByTextFromTextFeature(Description.class);
	}
