 ...
 * @author Stephan Richard Palm
 *
 * Format is declared final because it extends ChoiceFeature and sets the attributeName.
 * All classes extending Format would save there information on the same spot.
 */
public final class Format extends ChoiceFeature {

	public Format(Medium medium) {
		super(medium, AbstractFeature.getEasyClassName(Format.class.getName()));
	}	

	static public ConfigurableComparator getComparator(){
		return new ByChoiceFromChoiceFeature(Format.class);
	}
}
