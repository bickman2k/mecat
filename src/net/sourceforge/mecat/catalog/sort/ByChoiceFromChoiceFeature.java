...
public class ByChoiceFromChoiceFeature implements ConfigurableComparator {

	Class<? extends ChoiceFeature> feature;

	public ByChoiceFromChoiceFeature(Class<? extends ChoiceFeature> c) {
		if (ChoiceFeature.class.isAssignableFrom(c)) {
			feature = c;
		}
		else
			feature = null;
	...
	public int compare(Medium medium0, Medium medium1) {
		...
		ChoiceFeature feature0 = (ChoiceFeature)medium0.getFeature(feature); 
		ChoiceFeature feature1 = (ChoiceFeature)medium1.getFeature(feature); 
        ...
        String key1 = feature0.get();
        String key2 = feature1.get();
    ...
    public ByChoiceFromChoiceFeature getCopy() {
        return new ByChoiceFromChoiceFeature(feature);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ByChoiceFromChoiceFeature)) 
            return false;
        
        ByChoiceFromChoiceFeature other = (ByChoiceFromChoiceFeature) obj;
