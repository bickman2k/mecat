...
public class ByNumberFromTextFeature implements ConfigurableComparator {

	Class<? extends TextFeature> feature;

	public ByNumberFromTextFeature(Class<? extends TextFeature> c) {
    ...
    /**
     * Compares to medium by a TextFeature that contains a number
     * the comparing order is
     * null < ... < -n < -n + 1 < ... < -1 < 0 < 1 < ...
     * 
     * @param medium0
     * @param medium1
     * @return the usual comparator values -1, 0, 1
     */
	public int compare(Medium medium0, Medium medium1) {
		...
		if (Integer.valueOf(feature0.get()).intValue() == Integer.valueOf(feature1.get()).intValue())
			return 0;
    ...
    public ByNumberFromTextFeature getCopy() {
        return new ByNumberFromTextFeature(feature);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ByNumberFromTextFeature)) 
            return false;
        
        ByNumberFromTextFeature other = (ByNumberFromTextFeature) obj;
