...
public abstract class LocalButton extends JButton implements LocalListener {
    ...
    public LocalButton(Action a) {
        super(a);
        update();
        Options.addLocalListener(new WeakLocalListener(this));
    }

    public LocalButton(Icon icon) {
        super(icon);
        update();
        Options.addLocalListener(new WeakLocalListener(this));
    }

/*    public LocalButton(String text, Icon icon) {
        super(text, icon);
        Options.addLocalListener(new WeakLocalListener(this));
    }

    public LocalButton(String text) {
        super(text);
        Options.addLocalListener(new WeakLocalListener(this));
    }*/
    ...
    public abstract String getLocalText();
