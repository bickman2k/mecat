...
public class CatalogMediaOptionPanel extends JPanel {
    ...
    public CatalogMediaOptionPanel(final AbstractMediaOption mediaOption) {
        this.mediaOption = mediaOption;

        checkBox = new SimpleLocalCheckBox(Options.getI18N(CatalogMediaOptionPanel.class), "Override the media's option for this catalog", mediaOption.isMediaOptionOverriden());
        checkBox.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent arg0) {
                mediaOption.setMediaOptionOverriden(checkBox.isSelected());
                setCorrectPanel();
            }
        });
    ...
    void setCorrectPanel() {
        ...
        MediaOptionPanel mop = null;
        if (mediaOption.isMediaOptionOverriden())
            mop = new MediaOptionPanel(mediaOption);
        else {
            mop = new MediaOptionPanel(getDefaultOption());
