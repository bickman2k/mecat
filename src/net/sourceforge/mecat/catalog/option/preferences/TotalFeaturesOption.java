...
public class TotalFeaturesOption implements FeaturesOption {

    final Listing listing;
    
    public TotalFeaturesOption(final Listing listing) {
    ...
    public FeatureOption getOption(Class< ? extends Feature> featureClass) {
        ...
        if (Options.AppPrefs.getGeneralOption().isUseCatalogOption())
            featureOption = listing.getCatalogPreferences().getFeaturesOption().getOption(featureClass);
        if (featureOption != null)
            return featureOption;
        featureOption = Options.AppPrefs.getFeaturesOption().getOption(featureClass);
        if (featureOption != null)
            return featureOption;
        featureOption = DefaultPreferences.defaultPreferences.getFeaturesOption().getOption(featureClass);
        return featureOption;
    }
