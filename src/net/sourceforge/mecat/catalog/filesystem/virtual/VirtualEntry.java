...
public abstract class VirtualEntry implements FileSystemEntry {

    final VirtualDirectory parent;
    
    public VirtualEntry(final VirtualDirectory parent) {
        this.parent = parent;
    }
    ...
    public String getFullName() {
        ...
        return parent.getFullName() + System.getProperty("file.separator") + getName();
    }
