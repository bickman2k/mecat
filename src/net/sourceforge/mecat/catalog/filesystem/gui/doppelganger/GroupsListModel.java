...
public class GroupsListModel implements TableModel, LocalListener {

    final List<DoppelgangerGroup> groups;
    
    public GroupsListModel(List<DoppelgangerGroup> groups) {
        this.groups = groups;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        FileEntry file = groups.get(rowIndex).firstElement().getFileEntry();
        switch (columnIndex) {
        case 0:
            return file.getName();
        case 1:
