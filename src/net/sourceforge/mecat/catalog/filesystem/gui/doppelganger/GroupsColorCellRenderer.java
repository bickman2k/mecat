...
public class GroupsColorCellRenderer implements TableCellRenderer {

	final List<DoppelgangerGroup> groups;
	
	public GroupsColorCellRenderer(final List<DoppelgangerGroup> groups) {
		this.groups = groups;
	}
	...
	public Component getTableCellRendererComponent(JTable table,
            ...
            int row, int column)
        {
			...
			if (isSelected)
			    ret.setBackground(groups.get(row).getType().selectedColor);
			else
			    ret.setBackground(groups.get(row).getType().color);
