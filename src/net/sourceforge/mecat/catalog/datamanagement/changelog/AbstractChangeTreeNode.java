...
public abstract class AbstractChangeTreeNode implements ChangeTreeNode {

    final ChangeTreeTransactionNode parent;
    
    public AbstractChangeTreeNode(final ChangeTreeTransactionNode parent) {
        this.parent = parent;
    }
    ...
    public boolean hasUserInvoked(int first) {
        return true;
    }
