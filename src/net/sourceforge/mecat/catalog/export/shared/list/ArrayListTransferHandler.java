 ...
 * 
 * from http://java.sun.com/docs/books/tutorial/uiswing/misc/example-1dot4/ArrayListTransferHandler.java
 * 
 * Modified to work with MeCat by Stephan Richard Palm
 */
...
public class ArrayListTransferHandler extends TransferHandler {
    ...
    public boolean importData(JComponent c, Transferable t) {
        ...
        ExportColJListListModel listModel = (ExportColJListListModel)target.getModel();
        ...
        for (int i=0; i < alist.size(); i++) {
            listModel.add(index++, (ExportDef) alist.get(i));
        }
        return true;
    }
    ...
    protected void exportDone(JComponent c, Transferable data, int action) {
        if ((action == MOVE) && (indices != null)) {
            ExportColJListListModel model = (ExportColJListListModel)source.getModel();
